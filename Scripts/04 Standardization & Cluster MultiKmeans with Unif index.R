...
#selected_features<-c("specie","A","Aloc","IntraDO","InterDO","E","TR")

cat(paste0("***Initialization***", "\n"))

#multi_centroidi<-seq(from=3, to=10, by=1)
multi_centroidi<-  c(6)
N <- 30
...
output_file<-paste0("./",Output_folder_cluster,"/centroid_classification_assignment_",tag,"_",n_centroidi,".csv")
...
best_clusterisation_file = paste0("./Eval/centroid_classification_assignment_",best_clusterisation,".csv")
...
output_file_c<-paste0("./Eval/centroid_labelled_",tag,"_",n_centroidi,".csv")
